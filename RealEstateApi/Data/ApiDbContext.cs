...
namespace RealEstateApi.Data
{
   public class ApiDbContext : DbContext
   {
      ...
      protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
      {
         ...
         optionsBuilder.UseSqlServer("Data Source=.; Initial Catalog=ReaEstateDb01; Trusted_Connection=True; MultipleActiveResultSets=true; TrustServerCertificate=true; user=sa; password=abcd123!");
      }
